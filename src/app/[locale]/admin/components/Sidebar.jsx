...
const Sidebar = () => {
  ...
  const { setActiveSection,activeSection } = useDashboard();
    ...
    >
      ...
      <ul className="h-3/4 flex flex-col gap-9" style={{ color: "#FFFFFF" }}>
        <li
          ...
          style={{ color: hover === "Home" || activeSection === "home" ? "#ff9800" : "#FFFFFF"  }}
        ...
        <li
          ...
          onMouseLeave={() => sitHover(null)}
          style={{ color: hover === "Create" || activeSection === "CreateTrip" ? "#ff9800" : "#FFFFFF" }}
        >
        ...
        <li
          ...
          onMouseLeave={() => sitHover(null)}
          style={{color: hover === "information" || activeSection === "UserInformation" ? "#ff9800" : "#FFFFFF" }}
        >
        ...
        <li
          ...
          onMouseLeave={() => sitHover(null)}
          style={{ color: hover === "Update" || activeSection === "UpdateTrip" ? "#ff9800" : "#FFFFFF"}}
        >
        ...
        <li
          ...
          onMouseLeave={() => sitHover(null)}
          style={{color: hover === "Reservation" || activeSection === "Reservation" ? "#ff9800" : "#FFFFFF"}}
        >
          <HiOutlineInformationCircle style={{ fontSize: "28px" }} />
          <Button
            style={{ color: hover === "Reservation" || activeSection === "Reservation" ? "#ff9800" : "#FFFFFF"}}
      ...
      <div className=" flex flex-row items-center justify-center gap-3">
        ...
        <Link href={"/"} style={{ color:hover === "SolDelNile" ? "#ff9800" : "#FFFFFF", fontWeight: "700" }}  onMouseEnter={() => sitHover("SolDelNile")}
          onMouseLeave={() => sitHover(null)}>
          Back to SolDelNile
        </Link>
      </div>
