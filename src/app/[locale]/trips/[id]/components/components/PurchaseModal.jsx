...
export default function PurchaseModal({ trip, onClose }) {
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center bg-black/70 backdrop-blur-sm z-50 transition-opacity animate-fadeIn overflow-y-scroll pt-87 lg:pt-0">
      <div
